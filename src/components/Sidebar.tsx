...
import { LayoutGrid, BarChart3, Database, Plus, ChevronRight, ChevronLeft, Hash, Bot, Palette, HardDrive } from 'lucide-react';
...
export function Sidebar({ view, setView, projects, activeProject, activeThreadId, onSelectProject, onNewProject, onSelectThread, onAddThread, collapsed, onToggle, onLogout, onProfile }: {
  ...
  const navItems = [
    ...
    { id: 'myspace' as View,     icon: HardDrive,   label: 'My Space'   },
